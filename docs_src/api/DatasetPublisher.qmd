...
| [publish_with_s3](#atdata.atmosphere.DatasetPublisher.publish_with_s3) | Publish a dataset record with S3 storage. |
| [publish_with_urls](#atdata.atmosphere.DatasetPublisher.publish_with_urls) | Publish a dataset record with explicit HTTP URLs. |
...
### publish_with_s3 { #atdata.atmosphere.DatasetPublisher.publish_with_s3 }
...
| keys        | [list](`list`)\[[str](`str`)\]                                                                                       | List of S3 object keys for shard files. | _required_ |
| schema_uri  | [str](`str`)                                                                                                         | AT URI of the schema record.            | _required_ |
| name        | [str](`str`)                                                                                                         | Human-readable dataset name.            | _required_ |
| region      | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | AWS region (e.g., 'us-east-1').         | `None`     |
| endpoint    | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | Custom S3-compatible endpoint URL.      | `None`     |
| description | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | Human-readable description.             | `None`     |
| tags        | [Optional](`typing.Optional`)\[[list](`list`)\[[str](`str`)\]\]                                                      | Searchable tags for discovery.          | `None`     |
| license     | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | SPDX license identifier.                | `None`     |
| metadata    | [Optional](`typing.Optional`)\[[dict](`dict`)\]                                                                      | Arbitrary metadata dictionary.          | `None`     |
| checksums   | [Optional](`typing.Optional`)\[[list](`list`)\[[ShardChecksum](`atdata.atmosphere._lexicon_types.ShardChecksum`)\]\] | Per-shard checksums.                    | `None`     |
| rkey        | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | Optional explicit record key.           | `None`     |
...
| Name        | Type                                                                                                                 | Description                                                     | Default    |
|-------------|----------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|------------|
| urls        | [list](`list`)\[[str](`str`)\]                                                                                       | List of individual shard URLs.                                  | _required_ |
| schema_uri  | [str](`str`)                                                                                                         | AT URI of the schema record.                                    | _required_ |
| name        | [str](`str`)                                                                                                         | Human-readable dataset name.                                    | _required_ |
| description | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | Human-readable description.                                     | `None`     |
| tags        | [Optional](`typing.Optional`)\[[list](`list`)\[[str](`str`)\]\]                                                      | Searchable tags for discovery.                                  | `None`     |
| license     | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | SPDX license identifier.                                        | `None`     |
| metadata    | [Optional](`typing.Optional`)\[[dict](`dict`)\]                                                                      | Arbitrary metadata dictionary.                                  | `None`     |
| checksums   | [Optional](`typing.Optional`)\[[list](`list`)\[[ShardChecksum](`atdata.atmosphere._lexicon_types.ShardChecksum`)\]\] | Per-shard checksums. If not provided, empty checksums are used. | `None`     |
| rkey        | [Optional](`typing.Optional`)\[[str](`str`)\]                                                                        | Optional explicit record key.                                   | `None`     |
