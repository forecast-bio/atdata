...
| [get_typed](#atdata.atmosphere.LensLoader.get_typed) | Fetch a lens record and return as a typed object. |
...
### get_typed { #atdata.atmosphere.LensLoader.get_typed }

```python
atmosphere.LensLoader.get_typed(uri)
```
...
| Name   | Type                                                              | Description             |
|--------|-------------------------------------------------------------------|-------------------------|
|        | [LexLensRecord](`atdata.atmosphere._lexicon_types.LexLensRecord`) | LexLensRecord instance. |
