...
::: {.callout-warning}
**Deprecated.** Use `atdata.Index` directly as the type annotation instead.
`AbstractIndex` is retained for backward compatibility and will be removed
in a future release. See [Index](local.Index.qmd) for the current API.
:::
