...
| Name   | Type                                                                                                                                                      | Description                                                                                                   | Default    |
|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|------------|
| where  | [Callable](`typing.Callable`)\[\[[pd](`pandas`).[DataFrame](`pandas.DataFrame`)\], [pd](`pandas`).[Series](`pandas.Series`)\] \| [Predicate](`Predicate`) | Predicate function or ``Predicate`` object that selects matching rows from the per-sample manifest DataFrame. | _required_ |
