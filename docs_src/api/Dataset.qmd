...
| Name         | Type   | Description                                                                                                                                             | Default    |
|--------------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| batch_size ( |        | obj:`int`, optional): The size of iterated batches. Default: None (unbatched). If ``None``, iterates over one sample at a time with no batch dimension. | _required_ |

#### Returns {.doc-section .doc-section-returns}

| Name   | Type                                                       | Description                                                      |
|--------|------------------------------------------------------------|------------------------------------------------------------------|
|        | [Iterable](`typing.Iterable`)\[[ST](`atdata.dataset.ST`)\] | obj:`webdataset.DataPipeline` A data pipeline that iterates over |
|        | [Iterable](`typing.Iterable`)\[[ST](`atdata.dataset.ST`)\] | the dataset in its original sample order                         |
...
| Name   | Type                                                       | Description                                                       |
|--------|------------------------------------------------------------|-------------------------------------------------------------------|
|        | [Iterable](`typing.Iterable`)\[[ST](`atdata.dataset.ST`)\] | A WebDataset data pipeline that iterates over the dataset in      |
|        | [Iterable](`typing.Iterable`)\[[ST](`atdata.dataset.ST`)\] | randomized order. If ``batch_size`` is not ``None``, yields       |
|        | [Iterable](`typing.Iterable`)\[[ST](`atdata.dataset.ST`)\] | ``SampleBatch[ST]`` instances; otherwise yields individual ``ST`` |
|        | [Iterable](`typing.Iterable`)\[[ST](`atdata.dataset.ST`)\] | samples.                                                          |
