...
| [`ac.foundation.dataset.entry`](#ac-foundation-dataset-entry) | Record | Index entry for a WebDataset-backed dataset with references to storage location and sample schema |
...
| [`ac.foundation.dataset.storageBlobs`](#ac-foundation-dataset-storageblobs) | Object | Storage via ATProto PDS blobs for WebDataset tar archives. Used in ac.foundation.dataset.entry storage union for max... |
...
| [`ac.foundation.dataset.resolveSchema`](#ac-foundation-dataset-resolveschema) | Query | Resolve a schema by its permanent NSID identifier. When version is omitted, resolves to the most recently created sch... |
| [`ac.foundation.dataset.label`](#ac-foundation-dataset-label) | Record | Named label pointing to a dataset record. Multiple labels with the same name but different versions can coexist, enab... |
| [`ac.foundation.dataset.resolveLabel`](#ac-foundation-dataset-resolvelabel) | Query | Resolve a named dataset label to its underlying dataset record. When version is omitted, resolves to the most recentl... |
...
### `ac.foundation.dataset.entry` <span class='lexicon-badge lexicon-badge-record'>Record</span> {#ac-foundation-dataset-entry}
...
#### `ac.foundation.dataset.entry#shardManifestRef` <span class='lexicon-badge lexicon-badge-object'>Object</span> {#ac-foundation-dataset-entry-shardmanifestref}
...
#### `ac.foundation.dataset.entry#shardChecksum` <span class='lexicon-badge lexicon-badge-object'>Object</span> {#ac-foundation-dataset-entry-shardchecksum}
...
#### `ac.foundation.dataset.entry#datasetSize` <span class='lexicon-badge lexicon-badge-object'>Object</span> {#ac-foundation-dataset-entry-datasetsize}
...
| `checksum` | [`ac.foundation.dataset.entry#shardChecksum`](#ac-foundation-dataset-entry-shardchecksum) | **yes** | Content hash for integrity verification |
...
Storage via ATProto PDS blobs for WebDataset tar archives. Used in ac.foundation.dataset.entry storage union for maximum decentralization.
...
| `checksum` | [`ac.foundation.dataset.entry#shardChecksum`](#ac-foundation-dataset-entry-shardchecksum) | no | Content hash for integrity verification (optional since PDS blobs have built-in CID integrity) |
...
### `ac.foundation.dataset.resolveSchema` <span class='lexicon-badge lexicon-badge-query'>Query</span> {#ac-foundation-dataset-resolveschema}
...
### `ac.foundation.dataset.label` <span class='lexicon-badge lexicon-badge-record'>Record</span> {#ac-foundation-dataset-label}
...
### `ac.foundation.dataset.resolveLabel` <span class='lexicon-badge lexicon-badge-query'>Query</span> {#ac-foundation-dataset-resolvelabel}
...
| `label` | [`ac.foundation.dataset.label#main`](#ac-foundation-dataset-label-main) | **yes** | The label record that was resolved |
