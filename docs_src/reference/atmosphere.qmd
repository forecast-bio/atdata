...
schema = loader.get("at://did:plc:abc/science.alt.dataset.sampleSchema/xyz")
...
lens_rec = loader.get("at://did:plc:abc/science.alt.dataset.lens/xyz")
print(lens_rec["name"])

# Find lenses by schema
lenses = loader.find_by_schemas(
    source_schema_uri="at://did:plc:abc/science.alt.dataset.sampleSchema/source",
    target_schema_uri="at://did:plc:abc/science.alt.dataset.sampleSchema/target",
)
```
...
- [Protocols](protocols.qmd) - Index and AbstractDataStore
